...
A super light container(~45Mb) with Kubectl from busybox prebuild on Docker hub with "automated build". This container is really useful to manage your kubernetes clusters from docker containers or from other k8s pods, jobs, cronjobs ...
